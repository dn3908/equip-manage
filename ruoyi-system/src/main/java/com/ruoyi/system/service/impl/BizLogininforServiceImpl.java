...
public class BizLogininforServiceImpl implements IBizLogininforService
{
    ...
    @Autowired
    private BizLogininforMapper logininforMapper;
     ...
     */
    @Override
    public void insertLogininfor(BizLogininfor logininfor)
    {
     ...
     */
    @Override
    public List<BizLogininfor> selectLogininforList(BizLogininfor logininfor)
    {
